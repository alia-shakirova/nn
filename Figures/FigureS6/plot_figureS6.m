...
dssr_a_nn = ncread('FigureS6.nc','dssr_a_nn');
dssr_a = ncread('FigureS6.nc','dssr_a');
dssr_a_ker = ncread('FigureS6.nc','dssr_a_ker');
...
for aind = 1:17
    for i = 12:19
        ...
        Ra_nn(i-11,aind) = mean(dssr_a_nn(ix,iy,aind),[1 2]);
        Ra_rtm(i-11,aind) = mean(dssr_a(ix,iy,aind),[1 2]);
        Ra_ker(i-11,aind) = mean(dssr_a_ker(ix,iy,aind),[1 2]);
    end
end
