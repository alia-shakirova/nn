% This script calculates shortwave radiative feedbacks at the TOA 
% in the Arctic between two climate states. State 1 - September 1992, 
% State 2 - September 2012. Feedback is defined as dR = R2 - R1.
% 
% To get the NN model that predicts the top net solar radiation
% (TSR) use the function nn_toa.m:
% >> tsr = nn_toa(tisr,fal,tciw,tclw,tcwv,hcc,mcc,lcc,sp,tco3)
...
tsr1 = nn_toa(tisr/24/3600,fal,tciw,tclw,tcwv,hcc,mcc,lcc,sp,tco3);
...
[tisr,fal,tciw,tclw,tcwv,hcc,mcc,lcc,sp,tco3] = vars{:};
tsr2 = nn_toa(tisr/24/3600,fal,tciw,tclw,tcwv,hcc,mcc,lcc,sp,tco3);
...
[tisr,fal,tciw,tclw,tcwv,hcc,mcc,lcc,sp,tco3] = vars{:};
tsr_a = nn_toa(tisr/24/3600,fal,tciw,tclw,tcwv,hcc,mcc,lcc,sp,tco3);
Ra = tsr_a - tsr1; % albedo feedback
...
[tisr,fal,tciw,tclw,tcwv,hcc,mcc,lcc,sp,tco3] = vars{:};
tsr_wv = nn_toa(tisr/24/3600,fal,tciw,tclw,tcwv,hcc,mcc,lcc,sp,tco3);
Rwv = tsr_wv - tsr1; % water vapor feedback
...
[tisr,fal,tciw,tclw,tcwv,hcc,mcc,lcc,sp,tco3] = vars{:};
tsr_c = nn_toa(tisr/24/3600,fal,tciw,tclw,tcwv,hcc,mcc,lcc,sp,tco3);
Rc = tsr_c - tsr1; % cloud feedback

% Save to a file 
dim = [length(1:360),length(1:maxlat)];
outfile = 'nn_toa_feedbacks_091992_092012.nc';
...
varid4 = netcdf.defVar(ncid,'tsr1','NC_FLOAT',[dimidx dimidy]);
varid5 = netcdf.defVar(ncid,'tsr2','NC_FLOAT',[dimidx dimidy]);
...
netcdf.putVar(ncid,varid4,tsr1);
netcdf.putVar(ncid,varid5,tsr2);
netcdf.putVar(ncid,varid6,tsr2-tsr1);
netcdf.close(ncid);